...
sudo wget https://github.com/christianhaitian/rk2020/rk2020/master/ForThera/Update3.1/BootFileUpdates.tar.gz -a "$LOG_FILE"
sudo wget https://github.com/christianhaitian/rk2020/rk2020/master/ForThera/Update3.1/KernelUpdate.tar.gz -a "$LOG_FILE"
